...
public class GradingService {
    ...
    public void addGrading(Grading gr) throws ValidatorException {
        repository.save(gr);
    }

    public void deleteGrading(Long id) throws ValidatorException {
        repository.delete(id);
    }

    public void updateGrading(Grading gr) throws ValidatorException {
